void updateDetailsTexts(std::string lastPlayed, Playtime playtime)
{
    try
    {
        MainpageElements::details::lastPlayedDateText.setString(tr("IDS_TEXT_MAINDETAILS_LASTPLAYDATE") + lastPlayed);
        MainpageElements::details::totalPlayTimeInstanceText.setString(tr("IDS_TEXT_MAINDETAILS_TOTALPLAYTIME") + std::to_string(playtime.hours) + "H " + std::to_string(playtime.minutes) + "M " + std::to_string(playtime.seconds) + "S " + std::to_string(playtime.miliseconds) + "Ms"); 
    }
...
void totalPlayTimeCalc()
{
    ...
    MainpageElements::details::totalLauncherPlaytimeText.setString(tr("IDS_TEXT_MAINDETAILS_TOTALPLAYTIME") + std::to_string(totalTime.hours) + "H " + std::to_string(totalTime.minutes) + "M " + std::to_string(totalTime.seconds) + "S " + std::to_string(totalTime.miliseconds) + "Ms");     
}
